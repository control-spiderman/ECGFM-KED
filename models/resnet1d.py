...
# user:User
# Author: tyy
# createtime: 2023-08-18 19:50
# --coding:utf-8--
# project:
# user:User
# Author: tyy
# createtime: 2023-08-18 19:44
...
if __name__ == '__main__':
    import torch
    model = ResNet1d(input_dim=(12, 1024),
                     blocks_dim=list(zip([64, 128, 196, 256, 320], [1024, 256, 128, 64, 16])),
                     n_classes=5,
                     kernel_size=17,
                     dropout_rate=0.5)
    x = torch.rand(64, 12, 1024)  # 2, 32, 2000
    print(model(x).shape)